...
st.image("https://analytics.com/wp-content/uploads/2019/11/Customer-Lifetime-value-new-1.jpg", use_column_width = True)
...
st.sidebar.markdown(""" **Made with :heart: by sai kumar** """)
...
[Example CSV Input File](https://raw.githubusercontent.com/SAIKUMAR109/customer-lifetime-prediction-using-python/main/model_deployment/sample_file.csv)
...
Also, please make sure the columns are in proper format. For reference you can download the [dummy data](https://raw.githubusercontent.com/SAIKUMAR109/customer-lifetime-prediction-using-python/main/model_deployment/sample_file.csv).
